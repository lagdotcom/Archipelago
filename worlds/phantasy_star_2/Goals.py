...
all_goals = [
    GoalData(GOAL_MOTHER_BRAIN, {
        ...
        I.SmallKey, I.Letter, I.Dynamite, I.Teim,
        I.Dynamite, I.Dynamite, I.Recorder,
        I.KeyTube, I.JetScooterFlag,
        I.MruraLeaf, I.MruraGum, I.NeifirstFlag,
        I.MusikFlag, I.RedCard, I.YellowCard, I.BlueCard, I.GreenCard,
        I.RedDamFlag, I.YellowDamFlag, I.BlueDamFlag, I.GreenDamFlag, I.SpaceshipFlag,
        I.Prism,
        I.NeiCrown, I.NeiMet,
        I.NeiShot, I.NeiSlasher,
        I.NeiCape, I.NeiArmor,
        I.NeiShield, I.NeiEmel,
        I.NeiSword, I.WinTheGameFlag,
    ]),
]
