...
class BattleSprite(NamedTuple):
    ...
    def to_bytes(self):
        return (
            self.high_byte.to_bytes(1, "big")
            + self.mapping.to_bytes(3, "big")
            + self.art.to_bytes(4, "big")
        )
...
""",
    portrait=Portrait(
        Pal.Rolf, ART_PORTRAIT_ROLF, Win.RolfPortrait, 0x4102, MAPPING_PORTRAIT_ROLF
    ),
...
""",
    portrait=Portrait(
        Pal.Nei, ART_PORTRAIT_NEI, Win.NeiPortrait, 0x4102, MAPPING_PORTRAIT_NEI
    ),
...
""",
    portrait=Portrait(
        Pal.Amy, ART_PORTRAIT_AMY, Win.AmyPortrait, 0x4102, MAPPING_PORTRAIT_AMY
    ),
...
""",
    portrait=Portrait(
        Pal.Hugh, ART_PORTRAIT_HUGH, Win.HughPortrait, 0x4102, MAPPING_PORTRAIT_HUGH
    ),
...
""",
    portrait=Portrait(
        Pal.Anna, ART_PORTRAIT_ANNA, Win.AnnaPortrait, 0x4102, MAPPING_PORTRAIT_ANNA
    ),
...
""",
    portrait=Portrait(
        Pal.Kain, ART_PORTRAIT_KAIN, Win.KainPortrait, 0x4102, MAPPING_PORTRAIT_KAIN
    ),
...
""",
    portrait=Portrait(
        Pal.Shir, ART_PORTRAIT_SHIR, Win.ShirPortrait, 0x4102, MAPPING_PORTRAIT_SHIR
    ),
